...
#
# WWW (Linux): https://github.com/linuxhw
# WWW (BSD):   https://github.com/bsdhw
#
# Copyright (C) 2014-2023 Linux Hardware Project
#
# Written by Andrey Ponomarenko (ABI Laboratory, LSB Infrastructure,
# Broad Test technology, IEEE certified software test
...
my %VendorJedec = (
    ...
    "Crucial"   => ["1315", "059B", "859B", "9B85", "9B05", "0D9B", "09B8", "7F7F7F7F7F9B0000", "7F7F7F7F7F9BFFFF", "0000000000009B85", "859<", "009D36160000", "009C2B0C0000", "9B000D1000000000", "F7F7F7F7F7B90000", "9B"],
    "Dane-Elec" => ["7FDA"],
    "DERLAR"    => ["8AA2"],
    ...
    "Foxline"   => ["88F2", "8ABA"],
    "G-Alantic" => ["08F7"],
    "G.Skill"   => ["04CD", "CD04", "7F7F7F7FCD000000", "04=>", "=>04", "EC9D0B160000"],
    "GIGABYTE"   => ["89F2"],
    ...
    "Micron"    => ["002C", "00C2", "802C", "857F", "878A", "2C00", "C200", "2CFF", "2C80", "2C0", "C20", "2C", "08D0", "009C162C0000", "FFFFFFFFFFFFFF2C", "0000000000002C80", "0000000002C80", "2C080905DF3FF327", "2C1600000000", "00002C0F0000"],
    ...
    "PUSKILL"   => ["8AAD"],
    "Qimonda"   => ["7F7F7F7F7F510000", "5145", "F7F7F7F7F7150000", "80C1", "85517FB38551", "855180B38551"],
    "Qumo"      => ["02B5"],
    "Ramaxel"   => ["7F7F7F7F43000000", "0443", "04430000802C", "7F7F7F7F7F000000", "000000437F7F7F7F"],
    "Reboto"    => ["0080000080CE"],
    "Samsung"   => ["EC00", "00CE", "80CE", "00EC", "CE00", "CE80", "0CE", "EC0", "CE0", "000000000000CE80", "CE80", "CE30", "00000000000000CE", "CE01", "009C360B0000", "0000CE020000", "009C0B160000", "09B0", "090D", "000000000CE80", "7F7F7F7F3B000000"],
    "SanMax"    => ["86E9"],
    "SemsoTai"  => ["09C8"],
    "Sesame"    => ["0B13"],
    "Silicon Power" => ["86D3", "7F7F7F7F7F7FD300"],
    "SiS"       => ["7F7F7F7F7F7FA800"],
    "SK hynix"  => ["00AD", "00DA", "DA00", "6F2B", "80AD", "AD00", "ADFF", "AD01", "AD80", "000000000000AD80", "00000000000000AD", "AD0", "DA0", "0AD8", "009C35230000", "009C2B160000", "0000AD010000", "0000000080AD", "08CD", "2E0400000000"],
    ...
    "V-Color"   => ["066D"],
    "V-GeN"     => ["0A94", "8A94"],
    "Walton Chaintech" => ["05D6", "7F7F7F7F7FD60000"] # APOGEE
);
...
my %VendorRam = (
    "A Force"  => ["1GX64", "1GX72", "128X64K", "256X64M", "25664Y", "51264V"],
    "ADATA"    => ["AD7", "AM1", "EL7YG", "HYOPE"],
    "Advantech" => ["SQR"],
    "Aeneon"   => ["AET"],
    "AMD"      => ["AE32G", "AE34G", "AP34G", "AE38G", "AP38G", "AV34G", "R33", "R53", "R5S", "R7S", "R9S", "R73", "R74", "R93", "R94"],
    "Atermiter"=> ["Atermite"],
    ...
    "Essencore"=> ["IM44GU", "KD48GS"],
    "Exceleram"=> ["E301", "E302", "E408", "E404", "E470", "EPH4"],
    "EVGA"     => ["08G-D3", "16G-D4-2400-MR"],
    "Foxline"  => ["FL1", "FL2"],
    "G-Alantic"=> ["D3SS"],
    "G.Skill"  => ["F2-", "F3-", "F4-"],
    "GeIL"     => ["CL9-9", "CL9-10", "CL10-10", "CL10-11", "CL11-11", "CL11-12"], # Golden Empire
    "GIGABYTE" => ["AR32", "AR36", "GP-GR"],
    "Gloway"   => ["TYA", "TYP"],
    "Goldkey"  => ["BKH", "GKE", "GKH"],
    "Goldenmars" => ["GMT"],
    ...
    "Mushkin"  => ["991769", "992017", "991529", "991558", "991713", "992070", "991705", "MB[A/B]", "MR[A/B]"],
    ...
    "Ramos"    => ["EMB", "EWB", "RMB"],
    "RyzerX"   => ["RVR"],
    "Samsung"  => ["M04", "M378", "M393", "M4 70T", "M471", "K3Q", "K4A", "K4E", "K4F", "K4U", "Ltd:R00MM", "U6E", "UBE"],
    "Sesame"   => ["S939", "S949"],
    "SGS/Thomson" => ["SD-D2", "SD-D3"],
    "Silicon Power" => ["DBLT", "DBST", "DCLT", "DCST", "SP0", "ESRD"],
    "SK hynix" => ["HCN", "HMA", "HMT", "HMP", "HYMP", "H5AN", "H9CC", "H9HC", "DMT3", "MMXIV", "MPP", "4GBPC1333512", "4GBPC"],
...
my %VendorDiskPrefix = (
    ...
    "Delkin Devices" => ["ME16"],
    "Digma"    => ["1TB RUN S9", "256GB RUN S9", "RUN S9", "RUN Y2"],
    "DST"      => ["DST"],
    "Emphase"  => ["G5RM"],
    "Exascend" => ["EXS"],
    "ExeGate"  => ["EX2"],
    ...
    "KingDian" => ["SSD-S400"],
    "KingSpec" => ["ACJ", "ACS", "CHA", "IM032-S220", "KSD-PA", "KSQ120", "NT-32", "P3-512", "PA25-16", "SPK", "Q-90", "Q-180", "Q-360"],
    "Kingston" => ["AS400", "EK60H", "HyperX", "KC600", "KF-S42240", "Kingston", "RBU-SN"],
    "KIOXIA"   => ["KBG", "KXG"],
...
my $ALL_DRIVE_VENDORS = "Aarvex|Acer|ACPI|ADATA|A\-DATA|addlink|ADROITLARK|AFOX|Advantech|AEGO|Agile|AirDisk|ALLIED|AMD|AMP|ANACOMDA|Anobit|Aoluska|Apacer|Apple|ASUS|ATP|Aura|Avant|AVEXIR|Axiom|AXIOMTEK Corp\.|Azerty|Bamba|BaseTech|BHT|BIOSTAR|BIWIN|Bliksem|BlitzWolf|BLUERAY|BORY|BRAVEEAGLE|BUFFALO|Centerm|Chiprex|CLOVER|Colorful|Corsair|Crucial|CWDISK|Dahua|Dell|DEPO|DERLAR|DERLER|DeTech|DGM|DIERYA|Dogeish|DOGFISH|DOGGO|DREVO|DRVEO|EAGET|EGON|ELSKY|EMTEC|Espada|EXBOM|ExcelStor Technology|EYOTA|EZCOOL|e2e4|Fanxiang|Faspeed|FASTDISK|FATTYDOVE|FCS|FLEXXON|Fordisk|FORESEE|Force Le|Foxline|FUJITSU|GALAX|Galaxy|GAMER|Geil|GelL|geonix|Getrich|GIGABYTE|Gigastone|GLOWAY|Goldendisk|Goldenfir|Golden memory|Golden\-Memory|Goldkey|GOODRAM|Gost|GOWE|Gritronix|Hajaan|HECTRON|HEORIADY|HGST|Hitachi|Hoodisk|HP|HYPERDISK|Hyundai|i-FlashDisk|IBM-Hitachi|IBM|imation|Indilinx|INDMEM|Inland|Innodisk|InnoLite|INNOVATION[^\x00-\x7F]+IT|INNOVATION IT|INTEL|INTENSO|J\.ZAO|JAMESDONKEY|JASTER|JD|JIAWEI|JIESHUO|JMicron|JUHOR|JUMPER|KDATA|KimMiDi|Kimtigo|KINGBANK|Kingchuxing|KingDian|KingFast|KINGMAX|KINGPAN|KingPower|KINGRICH|Kingsand|KINGSHARE|King Share|KingSpec|Kingspeed|Kingston|KIOXIA-EXCERIA|KLEVV|KLLISRE|KLONER|KODAK|Kston|KUIJIA|KUU|Lanbo Flourishing|LDLC|LDNDISK|LenovoSPEED UP|Lenovo|LEQIXIANG|Leven|LEXAR|Lite-On|LITEON|LITEONIT|LONDISK|LuminouTek|LVCARDS|Magnetic Data|MARSHAL|MARVELL|Maximus|Maxmemroy|Maxtor|MediaMax|MENGMI|MicroData|MicroDream|Micron|Microtech|MidasForce|minisforum|MIXZA|Mushkin|Myung|Neo Forza|Netac|NFORCE|OCZ|OEM|ORICO|Origin Inception|ORTIAL|OWC|oyunkey|PALIT|Patriot|Pccooler|Pear|PHINOCOM|Phison|Pichau|Platinet|PLEXTOR|PNY|POLION|POWER X|PRETEC|Protectli|PUSKILL|Qianghe|QNIX|QUANTUM|QUMO|Qunion|Radeon|Ramaxel|RAMOS|Ramsta|RCESSD|Reeinno|Redapple|Reeioon|Reletech|RevuAhn|Rogueware|RunCore|RZX|Samsung Electronics|SAMSUNG|SAMSWEET|SandForce|SanDisk|SanPin|SATADOM|SATAFIRM|SCY|Seagate|SemsoTai|SenDisk|SETHRISE|ShanDianZhe|ShiJi|Shinedisk|SILICONMOTION|Silicon Motion|SK hynix|SMART|Smartbuy|SMI|Solidata|SOYO|SPCC|SSSTC|Star Drive|SUNEAST|SUNTRSI|SuperMicro|SuperSSpeed|SuperTalent|Synology|T\-CREATE|T\-FORCE|TAISU|takeMS|TAMMUZ|TANCA|TCSUNB0W|TCSUNBOW|TEAM|Teclast|tecmiyo|TEUTONS|TEXTORM|TEKET|THU|tigo|Timetec|TOPMORE|TopSunligt|TOSHIBA|Transcend|TurXun|TUSUNBOW|TwinMOS|TXRUI|UDinfo|UMAX|UMIS|UNIC2|V-Gen|Value Tech|Valuetech|Vaseky|VENO SCORP|Veno|Verbatim|VERICO|VBOX|VICKTER|VICK|ViperTeq|VisionTek|VISIPRO|VIVA|VNYEZ|WALRAM|WDC|Wdstars|Wdxsky|WellcommMaster|Western Digital|Wintec|Wolf Aure|Xinhaike|XPG|XrayDisk|XSTAR|XUNZHE|YMTC|Zheino|ZhiTai|ZOTAC|ZOZT|2\-Power";
...
my %VendorDiskModel = (
    ...
    "Blackpcs" => ["AS201 SSD"],
    "China"    => [
        "128MB ATA Flash Disk", "1TB PCS 2.5-inch SSD", "1TB QLC SATA SSD", "1TBE 1TB", "2.5 SATA SSD", "2.5 SSD 240GB", "2.5'' SSD 120GB", "240G SATA III SSD", "256GB PCS 2.5-inch SSD", "256GB QLC SATA SSD", "256GB SATA SSD", "512GB PCS 2.5-inch SSD", "512GB QLC SATA SSD",
        "AC211-480GB", "ASS-120",
        ...
        "D128GSSDQ400S", "DHMSR64GD81BC1QC",
        ...
        "HOM128M-46XI2",
        "IM256-WG30", "IM3D L06B B0KB",
        "JDa He SATA DISK", "JWX 16GB MSATA",
        "K1", "KCG SSD", "KR 32G", "Kston128GB",
        "L06B B0KB", "LS 256G M300", "LS 512GB M300",
        "M.2 2280-1TB SSD", "M.2 2280 SATA SSD", "M.2 SSD", "M10C", "M900-1T", "Mit-SSD128A", "MKSCE1BD060M4", "MLC", "MS06", "MS07", "MS201-512G", "mSATA SSD", "mSATA-64GB SSD", "Msata", "mSATAS3-0060-XQE8(010)", "mSATA 128GB", "MTG-480GB", "MW02 128GB MSATA",
        "N86-256GB", "N900-128", "NGFF 2242 32GB SSD", "NGFF 2242 240GB SSD", "NGFF 2242 512GB SSD", "NGFF 2280 128GB SSD", "NGFF 2280 256GB SSD", "NGFF 2280 512GB", "NGFF 2280 512GB SSD", "NGFF 2280 1TB SSD",
        "OEMSSD240GB", "OOS250G",
        "PATA SSD", "PSX-NGFF256G",
        "QST8-512",
        "R580", "REVOLUTIONS500_256",
        "S3 SSD", "S500", "s60 60gb", "SATA SSD", "SATA2 32GB SSD", "SCCTS-603-128G SSD", "SHMST6D128GHM11EMC 118000102", "SIC-1TB", "SK 64GB", "SK 256GB", "SK600-32GB", "sk600 128gb", "Solid", "SSD-128GB", "SSD-1TB", "SSD512M2S80", "SSDG2-240G", "SSDG2-256G", "SSDS2TA120G-BULK", "SSE128GMLCT-SBC-2S", "SSE256GMLCT-SBC-2S", "SSE256GMLCT-SBC-4S", "SSV4", "SSV5", "SW-120GB", "SV9SAT6B480GLM21DR",
    ...
    "INNOVATION IT" => ["SSD_M.2_256GB_InnovationIT", "SSD_2.5-inch_TLC_256GB_InnovationIT", "SSD_2.5-inch_TLC_240GB_InnovationIT", "SSD_2.5-inch_TLC_512GB_InnovationIT", "SSD_2.5-inch_1TB_InnovationIT_QLC", "SSD_M.2_512GB_InnovationIT_QLC"],
...
my %DiskModelVendor = ();
foreach my $V (sort keys(%VendorDiskModel))
{
    foreach (sort @{$VendorDiskModel{$V}}) {
        $DiskModelVendor{$_} = $V;
    }
}
...
my $DEFAULT_VENDOR = "China"; # NO NAME
...
sub getDefaultType($$$)
{
    ...
    if($Bus eq "usb")
    {
        ...
        or $Device->{"Vendor"}=~/Synaptics/ and $DId=~/00(81|9a|9b|a2|a8|bb|bd|be|c7|c9|df|e7|e9|f0|f9)/
...
sub probeHW()
{
    ...
    else
    {
        ...
        $DevFiles = hideByRegexp($DevFiles, qr/nvme-eui\.([a-f\d]+)/);
    ...
    foreach my $Info (split(/\n\n/, $HWInfo))
    {
        ...
        if(not $Device{"Vendor"})
        {
            if($Bus eq "ps/2")
            {
                if($Device{"Type"}=~/touchpad|touchscreen|mouse/)
                {
                    ...
                    elsif($Device{"Device"}=~/\A(ALPS|Goodix|Wacom) /i) {
                        $Device{"Vendor"} = $1;
                    }
    ...
    elsif(checkCmd("dmesg"))
    {
        ...
        if(not isBSD() and -e $Messages and -r $Messages)
        {
            ...
            {
                my $KernelMessages = runCmd("grep -I ' kernel: \\[' $Messages | sed 's/.* kernel: \\[/\\[/g'");
            ...
            if($ID=~/\A(usb|pci|ide|sdio):/)
            {
                if($1 ne "pci" or $PCIDrivers)
                {
                    ...
                    if($DevType eq "network")
                    {
                        ...
                        {
                            my @TotalCards = grep {$HW{$_}{"Type"} eq "network"} keys(%HW);

                            if($HW{$ID}{"Driver"})
                            {
                                if(defined $UsedNetworkDev{$File}
                                or (keys(%UsedNetworkDev)==1 and $#TotalCards==0))
                                {
                                    $HW{$ID}{"Status"} = "works";
    ...
    foreach my $Info (split(/\n\n/, $Dmidecode))
    {
        ...
        elsif($Info=~/Memory Device\n/) # $Info=~/Memory Module Information\n/
        {
            ...
            if(not $Device{"Vendor"} or isUnknownRam($Device{"Vendor"}) or isJedecRam($Device{"Vendor"}))
            {
...
sub detectDrive(@)
{
    ...
    elsif($Desc=~/User Capacity:\s*([\d\,]+)\s+bytes/)
    { # NVMe
        $Device->{"Capacity"} = $1;
        $Device->{"Capacity"}=~s/,//g;
        $Device->{"Capacity"} = bytesToHuman($Device->{"Capacity"});
    }
    ...
    if(defined $HW{$HWId})
    {
        if($Device->{"Capacity"}=~/KB/
        and $HW{$HWId}->{"Capacity"}!~/KB/)
        {
            $Device->{"Capacity"} = $HW{$HWId}->{"Capacity"};
        }
    }
...
sub nonVendor($) {
    return (length($_[0])<2 or $_[0]=~/\A\d+GB\Z/ or grep { lc($_[0]) eq lc($_) } ("1TB", "M.2", "mSATA", "N600", "PATA", "PCIe", "SSD", "SATAII", "SATAIII", "SATA", "SATA2", "SATA3", "Series", "SB", "SC2"));
}
...
sub isJedecRam($)
{
    ...
    if($Vendor=~/\A[A-F0-9]{16}\Z/
    or $Vendor=~/\A[A-F0-9]{4}\Z/) {
        return 1;
    }
...
sub guessDeviceVendor($)
{
    ...
    if($Device=~/(\A|\s)($ALL_DRIVE_VENDORS|$ALL_VENDORS|$ALL_CDROM_VENDORS)([\s_\-\[]|\Z)/i) {
        return $2;
    }

    if($Device=~/\A($ALL_DRIVE_VENDORS_SHORT)\s/) {
        return $1;
    }
...
sub shortID($$)
{
    my ($Bus, $ID) = @_;
    my $Len = length($ID);
    my $BusLen = length($Bus);
    my $MaxLen = 100;
    my $ShaLen = 8;
    if($Len + $BusLen + 1 > $MaxLen) {
        return substr($ID, 0, $MaxLen - $BusLen - 1 - $ShaLen - 1)."-".getSha512L($ID, $ShaLen);
    }
...
sub nameID(@)
{
    ...
    while ($Name=~s/(\s*\,\s*|\s+)(Inc|Ltda|Ltd|Co |Co|GmbH|Corp|Tech\.|Pte|LLC|Sdn|Bhd|BV|AG|RSS|PLC|s\.r\.l\.|srl|S\.P\.A|B\.V|S\.A|s r\. o|s\.r\.o|z\.s\.p\.o|Ind|e\.V|a\.s|Co\.Ltd|Int\'l|Intl|I\.T\.G|IND\.CO\.|zrt\.|S\.A\. de C\.V\.|GmbH \& Co\. KG|S\.L\.|d\.o\.o\.)(\.|\.*\Z)//gi) {}
...
sub fixFFBySubj($$$)
{
    my ($Val1, $Val2, $Strings) = @_;

    my %TypeMap = (
        "desktop"  => $DESKTOP_TYPE."|".$SERVER_TYPE,
        "server"   => $SERVER_TYPE,
        "notebook" => $MOBILE_TYPE
    );

    LOOP: foreach my $FF ("desktop", "server", "notebook", "tablet", "convertible", "all in one", "stick pc", "firewall", "mini pc", "nettop")
    {
        if(not defined $Strings->{$FF}
        or $Sys{"Type"} eq $FF) {
            next;
        }

        if(my $FFPattern = $TypeMap{$FF})
        {
            if($Sys{"Type"}=~/$FFPattern/) {
                next;
            }
        }

        if($FF eq "mini pc"
        and $Sys{"Type"} eq "stick pc") {
            next;
        }

        if(defined $Val2)
        {
            foreach my $V1Pattern (keys(%{$Strings->{$FF}}))
            {
                my $V2Pattern = join("|", @{$Strings->{$FF}{$V1Pattern}});
                if($V1Pattern ne "undef" and $V2Pattern)
                {
                    if($Val1=~/$V1Pattern/i and $Val2=~/$V2Pattern/) {
                        $Sys{"Type"} = $FF;
                        last LOOP;
                    }
                }
                elsif($V1Pattern ne "undef")
                {
                    if($Val1=~/$V1Pattern/i) {
                        $Sys{"Type"} = $FF;
                        last LOOP;
        ...
        {
            if(my $V1Pattern = join("|", @{$Strings->{$FF}}))
            {
                if($Val1=~/\b($V1Pattern)\b/)
                {
                    $Sys{"Type"} = $FF;
                    last LOOP;
                }
...
sub fixFFByCPU($)
{
    ...
    my %UnknownCPU = (
        "desktop"  => [ "Celeron CPU E\\d+", "Pentium (CPU G\\d+|D CPU|Dual-Core CPU E\\d+) ", "Core 2 CPU \\d+ ", "Core 2 Duo CPU E\\d+", "Core i\\d CPU \\d+ ", "Core i\\d-\\d+ CPU", "CPU Q(9400|8200)", "Athlon 64 X2 Dual Core Processor \\d+", "Athlon X4 \\d+", "Athlon 64 Processor \\d+\+", "Phenom II X[24] B?\\d+", "FX-\\d+ Six-Core", "A10\-\\d+K", "Xeon CPU (\\d+|[EXW]\\d{4}|(E5|D)-\\d{4}) ", "Core i7-\\d+ CPU", "FX-\\d+ Eight-Core", "Atom CPU C3508", "Ryzen 5 1600", "PPC970FX" ],
        "server"   => [ "Opteron X3216", "Xeon Silver", "Xeon Gold", "Xeon Platinum", "POWER" ],
        "notebook" => [ "Athlon Neo X2 .* L3", "Core i3 CPU M 380" ]
    );

    if($CPU!~/Mobile/) {
        fixFFBySubj($CPU, undef, \%UnknownCPU);
    }
...
sub fixFFByCDRom($)
{
    ...
    my %UnknownCDRom = (
        "desktop" => [ "DVR-118L", "DDU1615", "SH-222AB", "DVR-111D", "GSA-H10N", "CRX230EE", "iHAS122", "DVR-112D", "GH22LP20", "AD-7200A", "TS-H553A", "AD-7173A", "DVDRAM_GSA-H60N", "GH24NSB0", "SH-222BB", "SOHR-5238S", "ND-3540A" ]
    );

    fixFFBySubj($CDRom, undef, \%UnknownCDRom);
}
...
sub fixFFByBoard($)
{
    ...
    my %UnknownBoard = (
        "desktop"  => [ "DG965OT", "D510MO", "GA-K8NMF-9", "DG965RY", "DG33BU", "D946GZIS", "N3150ND3V", "D865GSA", "DP55WG", "H61MXT1", "D875PBZ", "F2A55", "Z68XP-UD3", "Z77A-GD65", "M4A79T", "775Dual-880Pro", "P4Dual-915GL", "P4i65GV", "D5400XS", "D201GLY", "MicroServer", "IPPSB-DB", "MS-AA53", "C2016-BSWI-D2", "N3160TN", "D915PBL", "EIRD-SAM", "D865PERL", "D410PT", "D525MW", "D945GCNL", "BSWI-D2", "B202", "D865GBF", "G1-CPU-IMP", "Aptio CRB", "A1SRi", "D865GVHZ", "IC17X", "N3050ND3H", "Bettong CRB", "E3C246D2I", "Pine Trail - M CRB", "Ultra 24", "DP55WB", "J3160NH", "CM-iAM" ],
        ...
        "tablet"   => [ "SurfTab" ],
        "all in one" => [ "AFLMB4-945GSE", "EZ1600" ]
    );

    fixFFBySubj($Board, undef, \%UnknownBoard);
}
...
sub fixFFByModel($$)
{
    ...
    my %UnknownModel = (
        ...
        "desktop" => {
            undef => [ "MacPro", "D865GLC", "ESPRIMO P", "Aspire easyStore", "X11SSL-F", "TERRA_PC", "VXC Class" ]
        },
        "firewall" => {
            undef => [ "Firewall" ],
            "Silver Peak Systems|Sophos" => [ undef ]
        },
        "server" => {
            undef => [ "X10DRG-O\\+-CPU", "ML10Gen", "Super Server", "H12SSW-NT", "X11SCE-F" ],
            "Neousys" => [ "Nuvo" ]
        },
        "stick pc" => {
            "MEEGOPAD" => [ undef ],
            undef => [ "IdeaCentre Stick" ]
        },
        "nettop" => {
            undef => [ "MS-B120", "IdeaCentre Q150" ]
        },
        "mini pc" => {
            undef => [ "Apple Mac mini", "Macmini", "ESPRIMO Q510", "MMLP5AP-SI", "Mini PC", "TL-WR842N", "Thin Client", "Thin Mini", "VMac mini", "Aptio CRB", "Propc Nano", "XS35V5", "M6JR120", "D425KT", "TV Box", "ZBOX\\-" ],
            "Beelink" => [ "\\ASII" ],
            "Chuwi"   => [ "Box" ],
            "Clientron" => [ "C800" ],
            ...
            "Orbsmart" => [ "\\AAW" ],
            "Radiant"  => [ "P845" ],
            "Supermicro" => [ "X11SSE-F", "A1SAi" ],
            "THD" => [ "RX2" ],
            "Ugoos" => [ "UT2" ],
            "ZOTAC" => [ "\\AZBOX" ]
        },
        "all in one" => {
            undef => [ " AiO PC", "AFLMB-9652", "\\A(MS-6657|EZ1601|AIO)\\Z" ],
            "Apple" => [ "\\AiMac" ],
            "BANGHO" => [ "B801" ],
            "Lenovo" => [ "\\A(S310|IdeaCentre B|ThinkCentre M90z) " ],
            "Hewlett" => [ " Aio\\Z" ],
            "MiTAC" => [ "\\AAIO " ],
            "MICRO-STAR" => [ "MS-AE3111", "MS-AA1511" ],
            "Samsung" => [ "SDNE-R78BA2-20" ],
        },
        "tablet" => {
            undef => [ "Hi10 .+ tablet", "Visconte4U", "TERRA_PAD" ],
            "ONDA" => [ "Tablet|V919" ],
            "Microsoft" => [ "Surface" ],
            "Hampoo" => [ "\\A(E4D6|D4D6|I1D6|P02BD6)" ],
            "Acer" => [ "ICONIA Tab" ],
            "TMAX" => [ "TM" ],
            "Wacom" => [ "Citiq" ]
        }
...
sub fixFFByMonitor($)
{
    ...
    my %UnknownMonitor = (
        "all in one" => [ "AIO PC" ],
        "notebook" => [ "LGD02E9", "SEC3445", "LPLA500", "CMO1680", "LGD018B", "APP9C20", "AUO11ED" ],
        "desktop"  => [ "VA1913w-2", "NS-39D310NA19", "TD2421" ]
    );

    fixFFBySubj($Mon, undef, \%UnknownMonitor);
}
...
sub probeDistr()
{
    ...
    if($LSB_Rel_F)
    {
        ...
        elsif($Descr=~/(BigLinux|Bluestar Linux|CryptoDATA|KDE neon|LMDE|Neptune|Pop\!_OS|PuppyRus-A)/) {
            $Name = $1;
        }
    ...
    if((not $Name or not $Release or $Name=~/\A(arcolinux|ubuntu|alt)/i) and $OS_Rel)
    {
        ...
        {
            my $RealName = $1;
            if($RealName=~/(Acronis Cyber Infrastructure|KDE neon|MakuluLinux|Peppermint|Pop\!_OS|Virtuozzo Infrastructure)/) {
                $Name = $1;
            }
        }
    ...
    if(grep {$Name eq $_} ("arch", "endeavouros", "garuda", "kaos", "void", "xero", "xerolinux-kde", "xerolinux-xfce") and not $Release) {
        $Release = "rolling";
    }
...
sub scenario()
{
    ...
    if($Opt{"IdentifyDrive"})
    {
        ...
        if(not -T $Opt{"IdentifyDrive"})
        {
            printMsg("ERROR", "not text file '".$Opt{"IdentifyDrive"}."'");
            exitStatus(1);
        }

        foreach my $DriveDesc (split("\n\n\n", readFile($Opt{"IdentifyDrive"})))
        {
            if(index($DriveDesc, "/dev") != 0) {
                next;
            }
    ...
    if($Opt{"FixProbe"})
    {
        ...
        { # Leave only hardware-specific logs, do not save logs and configs necessary for investigating problems
            ...
            if(my $Sysctl = readFile("$FixProbe_Logs/sysctl"))
            {
                if($Sysctl=~s/(debug.tslog_user:)(.|\n)+/$1 ...\n/g) {
                    writeFile("$FixProbe_Logs/sysctl", $Sysctl);
                }
            }
        }
    ...
    elsif($Opt{"FixProbe"})
    {
        ...
        {
            if($Sys{"DE"}=~/KDE/) {
                $Sys{"System"}=~s/\Aubuntu/kubuntu/;
            }
            elsif($Sys{"DE"}=~/LXDE|LXQt/) {
                $Sys{"System"}=~s/\Aubuntu/lubuntu/;
            }
            elsif($Sys{"DE"}=~/XFCE/) {
                $Sys{"System"}=~s/\Aubuntu/xubuntu/;
            }
            elsif($Sys{"DE"}=~/MATE/) {
