#!/bin/bash
# I use this script to build and publish deb packages in ppa:mikhailnov/hw-probe (https://launchpad.net/~mikhailnov/+archive/ubuntu/hw-probe)
...
for i in trusty xenial bionic cosmic disco
do
	...
	for ppa_name in ppa:mikhailnov/hw-probe ppa:mikhailnov/utils
	do
